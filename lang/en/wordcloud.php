...
$string['path_error'] = 'The expected page element could not be found or used.';
$string['pluginadministration'] = 'Wordcloud administration';
$string['pluginname'] = 'Wordcloud';
$string['previewbtn'] = 'Show preview';
$string['privacy:metadata'] = 'The wordcloud plugin stores which words each user has submitted to a wordcloud activity.';
$string['privacy:metadata:wordcloud_word_user_rel'] = 'A record linking a user to a word they submitted to a wordcloud activity.';
$string['privacy:metadata:wordcloud_word_user_rel:mapid'] = 'The ID of the submitted word (and its total submission count) this user contributed to.';
$string['privacy:metadata:wordcloud_word_user_rel:userid'] = 'The ID of the user who submitted the word.';
