...
$string['close'] = 'Closes: ';
$string['count'] = 'Count';
$string['divcolor1'] = 'Divergent color 1';
$string['divcolor1desc'] = 'Set the color for the least entered word. Define the color values as hexcode without #.';
$string['divcolor2'] = 'Divergent color 2';
$string['divcolor2desc'] = 'Set the color for the most entered word. Define the color values as hexcode without #.';
...
$string['usedivcolor'] = 'Use divergent color scheme';
$string['usedivcolor_help'] = 'Use a divergent color scheme for this wordcloud. The least and most entered word(s) will be each set to a color. Words with a different word count will get brighter luminosity.';
