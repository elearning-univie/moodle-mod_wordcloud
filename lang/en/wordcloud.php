...
$string['usemonocolor_help'] = 'Use a one color scheme for this wordcloud. All the words will have the same color, words with a different word count will get a brighter or darker luminosity. If not set, the words in the wordcloud will be painted in six different colors.';
